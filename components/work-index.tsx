  ...
  return (
    <div className="studio-shell">
      <section className="studio-grid" aria-label="My work and a little about me">
        ...
        <article className="studio-tile now-tile tile-wide">
        ...
        <article className="studio-tile results-tile tile-wide">
      ...
      <section className="project-masonry" aria-label="More projects">
        {remaining.map(project => <ProjectTile key={project.slug} project={project} />)}
      </section>
    </div>
  );
}
