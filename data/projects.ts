...
export const projects: Project[] = [
  ...
  {
    slug: "lv-schedule-viewer",
    title: "Louis Vuitton · Schedule Viewer",
    subtitle: "A simple shift viewer for Louis Vuitton employees in Portugal.",
    category: "App / Team Operations",
    section: "Product Experiments",
    group: "Personal Products",
    summary:
      "I built an app for Louis Vuitton employees in Portugal to organise their schedules and quickly see who starts work at what time. It turns shift information into a simple, easy-to-read view of the working day.",
    role: "Product Design & Development",
    tags: ["App", "Scheduling", "Team operations"],
    featured: false,
    detailCard: {
      type: "App",
      role: "Product Design & Development",
      whatIDid: [
        "Built the scheduling app",
        "Organised shifts into clear day, week, and month views",
        "Made it easy to check colleagues' start times",
        "Designed a simple interface for everyday use",
      ],
      outcome: {
        title: "Outcome",
        text: "A working app that helps employees check their schedules and see who starts when.",
      },
      status: "Live",
    ...
    overview: [
      ...
      "It brings shifts and start times into a clear interface, with day, week, and month views.",
    ],
    whatItIs: "A simple app for checking work schedules and colleagues' start times.",
  ...
  },
  {
    ...
    title: "Santos Populares Lisboa",
    subtitle: "Where to go, who is playing, and when during Lisbon's Santos Populares.",
    category: "App / Local Discovery",
    section: "Product Experiments",
    group: "Personal Products",
    summary:
      "I built an app to help people explore Lisbon's Santos Populares in 2026: find neighbourhood festivities, see who was performing where, and check locations and party schedules in one place.",
    role: "Product Design & Development",
    year: "2026",
    tags: ["App", "Lisbon", "Events", "Local discovery"],
    featured: false,
    detailCard: {
      type: "App",
      role: "Product Design & Development",
      whatIDid: [
        "Built the festival discovery app",
        "Brought neighbourhoods, locations, artists, and schedules together",
        "Added search and filters for finding relevant festivities",
        "Made events browsable in a list and on a map",
      ],
      outcome: {
        title: "Outcome",
        text: "A live guide to Lisbon's 2026 Santos Populares, helping visitors find festivities and plan where to go.",
      },
    ...
    overview: [
      ...
      "Visitors can search for an arraial, neighbourhood, or artist, check event schedules, and find locations on a map.",
    ],
    whatItIs: "A local discovery app for Lisbon's Santos Populares, combining artists, neighbourhoods, locations, and schedules.",
    ...
    gallery: [
      ...
      {
        type: "image", label: "Santos Populares map", src: "/assets/projects/santos-populares/map.png",
        alt: "Map of Lisbon's Santos Populares festivities with neighbourhood locations", fit: "cover", tone: "warm",
      },
    ],
  },
  {
